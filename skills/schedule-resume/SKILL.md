...
Resolve the current project directory as an absolute path. Resolve the applicable `CLAUDE.md`, `AGENTS.md`, or `GEMINI.md` under harness and project precedence. Include its path and relevant context in the continuation prompt.
