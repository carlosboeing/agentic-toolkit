...
name: learn
description: >-
  Explain a git diff, PR, file, folder, symbol, behaviour, or topic as a software-engineering lesson. Use for /learn, /learn pr <N>, /learn HEAD~N, /learn <sha>, /learn <path>, /learn <symbol>, /learn topic <name>, or requests like "explain what changed", "walk me through this folder", "how does login work", or "teach me about caching". Supports level keywords expert, intermediate, beginner, and eli5, depth keywords quick, standard, and deep, plus save and help modes.
